...
Software Engineer with commercial experience building production backend services, web applications, and mobile apps using C#, .NET Core, ASP.NET Core, MSSQL, React, and TypeScript. Experienced in making technical decisions across architecture and infrastructure, owning end-to-end delivery from design through production deployment, and working within Shape Up and Agile development methodologies.
